...
export default function Home() {
  return (
    <Layout
      title="Начало"
      description="Помощник за автоматизирано попълване и подаване на годишни финансови отчети (ГФО) към Националния статистически институт. Спестява време на счетоводители.">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
      </main>
