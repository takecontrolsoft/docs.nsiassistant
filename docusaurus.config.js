...
const config = {
  ...
  scripts: [
    {
      src: 'https://monitordash.takecontrolsoft.eu/js/md-track.js',
      'data-site': 'NSIDOC-239845TC',
      defer: true,
    },
  ],
  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        ...
        {property: 'og:description', content: 'Ръководство за инсталиране, конфигуриране и използване на НСИ Асистент. Спестява време и усилия при подаване на ГФО към НСИ.'},
      ],
      navbar: {
        title: 'НСИ Асистент',
        logo: {
